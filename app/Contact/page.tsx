...
function Contact() {
  ...
  if (state.succeeded) {
    return (
      <div className="text-center py-24 bg-gray-900">
        <h2 className="text-2xl text-white mb-4">Dziękujemy za wiadomość!</h2>
        <p className="text-gray-400">Skontaktujemy się z Tobą wkrótce.</p>
      </div>
    );
  }
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-12">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
            Masz pomysł i chciałbyś zrealizować projekt? Jesteśmy do dyspozycji.
          </p>
        </div>
          ...
          <div className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full">
              <button
                ...
                className="flex mx-auto text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
